...
const GetAllReviews = () => {
    ...
    const filteredData = reviewId && !ticketUserName && !reviewDate ?
        reviews.filter((objects) => objects.id === (reviewId)) :
        ticketUserName && !reviewId && !reviewDate ?
            reviews.filter((objects) => objects.title === ticketUserName) :
            reviewDate && !reviewId && !ticketUserName ?
                reviews.filter((objects) => objects.Idate === reviewDate) :
                reviewId && ticketUserName && !reviewDate ?
                    reviews.filter((objects) => objects.id === (reviewId) && objects.title == ticketUserName) :
                    ticketUserName && reviewDate && !reviewId ?
                        reviews.filter((objects) => objects.title === ticketUserName && objects.Idate == reviewDate) :
                        reviewId && ticketUserName && reviewDate ?
                            reviews.filter((objects) => objects.id === (reviewId) && objects.title === ticketUserName && objects.Idate === reviewDate) :
                            reviews
                                                            ...
                                                            <>
                                                                <div className=''>
                                                                    <div className="loader">
                                                                        <div className="spinner-border" style={{ height: "5rem", width: "5rem" }} role="reviewId">
